...
public class main {
    public static void main(String[] args) {
        ...
        laptops.add(new Laptop("ASUS", 256, "Windows 11 Домашняя"));

        laptops.add(new Laptop("Lenovo", 128, "Windows 10 Профессиональная"));

        laptops.add(new Laptop("Acer", 1024, "Без ОС"));

        laptops.add(new Laptop("HUAWEI", 512, "Windows 11 Домашняя"));
